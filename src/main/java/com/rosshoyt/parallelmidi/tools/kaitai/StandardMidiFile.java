...
public class StandardMidiFile extends KaitaiStruct {
   ...
   public static class TrackEvents extends KaitaiStruct {
      ...
      public TrackEvents(KaitaiStream _io, Track _parent) {
         this(_io, _parent, null);
      }

      public TrackEvents(KaitaiStream _io, Track _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
      ...
      public Track _parent() { return _parent; }
   }
   public static class TrackEvent extends KaitaiStruct {
      ...
      public TrackEvent(KaitaiStream _io, TrackEvents _parent) {
         this(_io, _parent, null);
      }

      public TrackEvent(KaitaiStream _io, TrackEvents _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
      ...
      public StandardMidiFile _root() { return _root; }
      public TrackEvents _parent() { return _parent; }
   }
   public static class PitchBendEvent extends KaitaiStruct {
      ...
      public PitchBendEvent(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public PitchBendEvent(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
      ...
      public StandardMidiFile _root() { return _root; }
      public TrackEvent _parent() { return _parent; }
   }
   public static class ProgramChangeEvent extends KaitaiStruct {
      ...
      public ProgramChangeEvent(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public ProgramChangeEvent(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
   ...
   public static class NoteOnEvent extends KaitaiStruct {
      ...
      public NoteOnEvent(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public NoteOnEvent(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
   ...
   public static class PolyphonicPressureEvent extends KaitaiStruct {
      ...
      public PolyphonicPressureEvent(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public PolyphonicPressureEvent(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
   ...
   public static class MetaEventBody extends KaitaiStruct {
      ...
      public MetaEventBody(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public MetaEventBody(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
   ...
   public static class ControllerEvent extends KaitaiStruct {
      ...
      public ControllerEvent(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public ControllerEvent(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
   ...
   public static class SysexEventBody extends KaitaiStruct {
      ...
      public SysexEventBody(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public SysexEventBody(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
   ...
   public static class NoteOffEvent extends KaitaiStruct {
      ...
      public NoteOffEvent(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public NoteOffEvent(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
   ...
   public static class ChannelPressureEvent extends KaitaiStruct {
      ...
      public ChannelPressureEvent(KaitaiStream _io, TrackEvent _parent) {
         this(_io, _parent, null);
      }

      public ChannelPressureEvent(KaitaiStream _io, TrackEvent _parent, StandardMidiFile _root) {
         super(_io);
         this._parent = _parent;
         this._root = _root;
         _read();
